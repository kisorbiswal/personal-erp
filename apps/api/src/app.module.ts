...
@Module({
  ...
  controllers: [HealthController, AuthController, EventsController, EventsActionsController, EventsTagsController, TagsController, BoardsController, FeedController],
