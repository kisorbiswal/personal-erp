    ...
    charts: [
      {
        ...
        series: [
          ...
          { slot: 'apple_health_weight', label: 'Apple Health (kg)', color: '#10b981', type: 'line' },
          { slot: 'fitbit_weight',       label: 'Fitbit (kg)',       color: '#f59e0b', type: 'line' },
        ],
      },
    ],
    requires: [
      { slot: 'mylogger_weight',     dataType: 'weight-scale', provider: 'mylogger',     fields: ['value_kg'], aggregation: 'weekly_avg', optional: true },
      { slot: 'apple_health_weight', dataType: 'weight-scale', provider: 'apple-health', fields: ['value_kg'], aggregation: 'weekly_avg', optional: true },
      { slot: 'fitbit_weight',       dataType: 'weight-scale', provider: 'fitbit',       fields: ['value_kg'], aggregation: 'weekly_avg', optional: true },
    ],
  },
};
